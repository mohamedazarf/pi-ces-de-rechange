...
//       >
//         <div className="max-w-[1600px] mx-auto px-12 lg:px-16 h-18 flex items-center justify-between">
//           {/* Logo */}
//           <div className="flex items-center gap-4">
//             <div className="w-8 h-8 bg-gradient-to-br from-blue-600 to-cyan-500 rounded-lg flex items-center justify-center relative overflow-hidden">
...
//           {/* Nav Links */}
//           <ul className="hidden md:flex items-center gap-12 text-sm font-normal text-slate-700">
//             {["Features", "Solutions", "Resources", "Pricing", "Contact"].map(
//               (item, i) => (
//                 <li key={i} className="relative group cursor-pointer">
//                   <a
//                     href={`#${item.toLowerCase()}`}
//                     className="tracking-wide transition-colors duration-300 group-hover:text-blue-600"
//                   >
//                     {item}
//                   </a>
...
//               Complete visibility into your financial operations with real-time
...
//               >
//                 Unified business management for growing companies. Connect your
//                 financials, sales, service, and operations.
//               </motion.p>
...
//               Business Central brings together all your core business functions
//               in one intelligent, cloud-based platform designed for growing
//               enterprises
//             </p>
//           </motion.div>
...
//               {
//                 title: "Products",
//                 links: ["Business Central", "Finance", "Sales", "Supply Chain"],
//               },
//               {
//                 title: "Resources",
//                 links: [
      ...
      >
        <div className="max-w-[1600px] mx-auto px-12 lg:px-16 h-18 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-12">
            <ul className="flex items-center gap-12 text-sm font-normal text-slate-700">
              {["Features", "Solutions", "Resources", "Pricing", "Contact"].map(
                (item, i) => (
                  <li key={i} className="relative group cursor-pointer">
                    <a
